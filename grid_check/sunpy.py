...
class Grid(object):
	...
	# numpy 1.10.1, see http://stackoverflow.com/questions/33098765/visibledeprecationwarning-boolean-index-did-not-match-indexed-array-along-dimen
	xp[np.where(self.cells.mask)]==0
	yp[np.where(self.cells.mask)]==0
